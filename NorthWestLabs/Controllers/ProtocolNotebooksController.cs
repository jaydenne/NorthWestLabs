...
namespace NorthWestLabs.Controllers
{
    public class ProtocolNotebooksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AssayID,AssayName,ProtocolID,EstDaysToComplete,Description,RequireAnimalTesting,ModifiedBy,ModifiedDate,CreatedBy,CreatedDate")] ProtocolNotebook protocolNotebook)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AssayID,AssayName,ProtocolID,EstDaysToComplete,Description,RequireAnimalTesting,ModifiedBy,ModifiedDate,CreatedBy,CreatedDate")] ProtocolNotebook protocolNotebook)
        {
            if (ModelState.IsValid)
            {
