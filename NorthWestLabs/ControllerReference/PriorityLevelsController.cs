...
namespace NorthWestLabs.ControllerReference
{
    public class PriorityLevelsController : Controller
    {
        ...
        {
            return View(db.PriorityLevels.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "PriorityLevelID,PriorityRate,WorkDaysProcessing,ModifiedBy,ModifiedDate,CreatedBy,CreatedDate")] PriorityLevel priorityLevel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriorityLevelID,PriorityRate,WorkDaysProcessing,ModifiedBy,ModifiedDate,CreatedBy,CreatedDate")] PriorityLevel priorityLevel)
        {
            if (ModelState.IsValid)
            {
