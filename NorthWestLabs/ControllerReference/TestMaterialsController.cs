...
namespace NorthWestLabs.ControllerReference
{
    public class TestMaterialsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TestID,MaterialID,UnitsRequired,ModifiedBy,ModifiedDate,CreatedBy,CreatedDate")] TestMaterial testMaterial)
        {
            ...
            ViewBag.TestID = new SelectList(db.Tests, "TestID", "Name", testMaterial.TestID);
            return View(testMaterial);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TestID,MaterialID,UnitsRequired,ModifiedBy,ModifiedDate,CreatedBy,CreatedDate")] TestMaterial testMaterial)
        {
            if (ModelState.IsValid)
            {
